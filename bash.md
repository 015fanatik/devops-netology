...
```
![3sh.png](https://github.com/015fanatik/devops-netology/blob/main/screenshots/3sh.png)
```
Так как недоступен первый из проверяемых IP скрипт отрабатывает break по его условию.
