...
5 Сколько IP-адресов в сети с маской /29 ?  
 В сети с маской /29 8 адресов из них 2 зарезервированный под адрес сети и броадкаст адрес . Соответственно продуктивных хостов 6  из них один шлюз если сеть маршрутизируемая.  
